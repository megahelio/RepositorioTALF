...
static const char *const yytname[] =
{
  ...
  "IDENTIFICADOR", "'-'", "'+'", "'*'", "'/'", "'\\n'", "'='", "$accept",
  "lineas", "linea", "expresion", YY_NULLPTR
};
#endif
...
{
       2,     0,     1,     0,     8,     9,    10,     4,     3,     0,
       7,     0,     0,     0,     0,     0,     6,    10,     0,    12,
      11,    13,    14,     5
};
...
{
       2,     3,    10,     4,     5,     6,     4,     5,    17,    11,
       7,    12,    13,    14,    15,    16,    12,    13,    14,    15,
      23,     0,    18,    19,    20,    21,    22,    14,    15
};

static const yytype_int8 yycheck[] =
{
       0,     1,    10,     3,     4,     5,     3,     4,     5,    11,
      10,     6,     7,     8,     9,    10,     6,     7,     8,     9,
      10,    -1,    11,    12,    13,    14,    15,     8,     9
};
...
{
       0,    13,     0,     1,     3,     4,     5,    10,    14,    15,
      10,    11,     6,     7,     8,     9,    10,     5,    15,    15,
      15,    15,    15,    10
};
...
#line 31 "calc.y" /* yacc.c:1646  */
    { insertar_diccionario(&diccionario, (yyvsp[-3].texto), (yyvsp[-1].valor_real)); }
...
#line 38 "calc.y" /* yacc.c:1646  */
    { ENTRADA * entrada = buscar_diccionario(&diccionario,(yyvsp[0].texto));
                                       if (entrada != NULL) { (yyval.valor_real) = entrada->valor; }
                                       else { printf("ERROR: variable %s no definida\n", (yyvsp[0].texto)); (yyval.valor_real) = 0; } }
#line 1255 "calc.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 41 "calc.y" /* yacc.c:1646  */
    { (yyval.valor_real) = (yyvsp[-2].valor_real) + (yyvsp[0].valor_real); }
